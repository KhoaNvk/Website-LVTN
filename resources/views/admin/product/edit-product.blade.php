...
@section('content_dash')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="ProductName" name="ProductName" type="text"
                                                   ...
                                                   value="{{$product->ProductName}}" placeholder="Vui lòng nhập tên"
                                                   data-errors="Please Enter Name." required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <input type="hidden" name="ProductSlug" class="form-control"
                                           value="{{$product->ProductSlug}}" id="convert_slug">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="idCategory" name="idCategory" class="selectpicker form-control"
                                                ...
                                                <option
                                                    value="{{$product->idCategory}}">{{$product->CategoryName}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="Price" name="Price" type="number" min="0" class="form-control"
                                                   value="{{$product->Price}}" placeholder="Vui lòng nhập giá"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="Quantity" name="QuantityTotal" type="number" min="0"
                                                   ...
                                                   placeholder="Vui lòng nhập số lượng" disabled>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="ShortDes" name="ShortDes" class="form-control"
                                                      placeholder="Nhập mô tả ngắn" rows="3"
                                ...
                                <button type="submit" class="btn btn-primary mr-2" id="btn-submit"
                                        value="Sửa sản phẩm"> Sửa sản phẩm
                                </button>
    ...
    <script>
        ...
        async function renderOptions() {
            const options = @json($productArray['options']);
        ...
        <div class="form-group col-md-5">
            ...
            <select name="attribute_item" class="form-control form_input_" onchange="getPropertyByAttribute(this)">
                ${attributes.map((attribute) =>
                        `<option value="${attribute.idAttribute}" ${attribute.idAttribute === el.attribute_item.idAttribute ? 'selected' : ''}>${attribute.AttributeName}</option>`
                    ).join('')}
            </select>
        </div>
        <div class="form-group col-md-5">
            <label for="property_item">Giá trị thuộc tính</label>
            <select name="property_item" class="form-control form_input_" data-sl="">
                <option value="${el.property_item.idAttrValue}">${el.property_item.AttrValName}</option>
            </select>
        </div>
        <div class="col-md-2 mt-4">
            <button type="button" onclick="removePropertyItem(this)" class="btn btn-danger">Xoá</button>
