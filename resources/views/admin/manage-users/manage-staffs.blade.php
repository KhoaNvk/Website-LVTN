                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center list-action">
                                        @if(Session::get('Position') == 'Quản Lý' && $staff->Position == 'Nhân Viên')
                                            <a class="badge bg-warning mr-2" data-toggle="modal" data-target="#modal-delete-{{$staff->idAdmin}}" 
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Bạn có muốn xóa nhân viên {{$staff->AdminName}} này không?</p>
                                        </div>
