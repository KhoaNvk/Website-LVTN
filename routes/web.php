...
Route::group(['prefix' => 'api'], function () {
    Route::group(['prefix' => 'attribute-values'], function () {
        Route::get('/list', [HomeController::class, 'getAttributeValueByAttributeId'])->name('api.attribute.values.list');
    });
    Route::group(['prefix' => 'products'], function () {
        Route::get('/info', [HomeController::class, 'getInfo'])->name('api.products.info');
    });
});
